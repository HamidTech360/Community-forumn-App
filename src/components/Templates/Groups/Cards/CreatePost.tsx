          ...
          <Card.Title>
            <Row className={styles.row}>
              ...
              <Col xs={8} md={8} className={styles.col}>
                <div>
                  <h4>Job market for international professionals in Germany</h4>
                  <small>Posted by Ephraim Nkonam . 3 hours ago</small>
                </div>
              </Col>
              <Col xs={2} md={1}>
                <NavDropdown
          ...
          <Card.Body className={styles.body}>
            <div>
              <p>
                ...
                Adipiscing fermentum, ut duis lorem facilisi enim, quis a neque.
                Urna, pretium pulvinar diam tincidunt pretium elit elementum.
                Sagittis faucibus augue mi elementum faucibus quis tristique
                varius. Suspendisse rhoncus, integer at ut lectus sed.
              </p>
              <Image
